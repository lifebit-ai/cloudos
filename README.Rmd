...
This object will be input to most of the other functions, which directly communicates with the cloudos server.
...
Get all the sample (participants) table from cohort browser. Optionally you can also add filters.
...
Get all the genotypic table from cohort browser. Optionally you can also add filters.
